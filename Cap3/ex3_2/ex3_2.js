function calcularPeso(){
    ...
    if (nome == '' || (masculino == false && feminino == false)){
        window.alert('Por favor, informe o nome e seleciona o sexo...');
    ...
    if (altura == 0 || isNaN(altura)){
        window.alert('Por favor, informe a altura corretamente...');
        inAltura.focus();
        return;
    }
    // se o masculino (significa se masculino == true)
    if (masculino){
